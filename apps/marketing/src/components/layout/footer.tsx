      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-6">
              ...
              <span className="text-xl font-bold text-white">Homicasa</span>
            </Link>
            <p className="text-surface-400 text-sm leading-relaxed">
              The modern property management platform for landlords and property
              managers.
            </p>
          </div>
        ...
        <div className="border-t border-surface-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-surface-500 text-sm">
            © {new Date().getFullYear()} Homicasa. All rights reserved.
          </p>
